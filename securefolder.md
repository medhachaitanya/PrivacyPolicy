...
This privacy policy applies to the Secure Folder, Files and Encrypt app (hereby referred to as "Application") for mobile devices that was created by MedhaChaitanya (hereby referred to as "Service Provider") as a Freemium service. This service is intended for use "AS IS".
